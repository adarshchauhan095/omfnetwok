      ...
      PopularPostsResp(
        ...
        result: json['result'] != null
            ? List<PopularPostData>.from(
                (json['result'] as List<dynamic>).map<dynamic>(
                  (dynamic x) => PopularPostData.fromJson(
      ...
      PopularPostData(
        ...
        taggedUsers: json['taggedUsers'] != null
            ? List<PopularTaggedUsers>.from(
                (json['taggedUsers'] as List<dynamic>).map<dynamic>(
                  (dynamic x) => PopularTaggedUsers.fromJson(
                    x as Map<String, dynamic>,
                  ),
                ),
              )
